...
<Card className="mb-4 shadow-sm border-0 mx-1" style={{ borderRadius: '20px', overflow: 'hidden', flexShrink: 0 }}>
    <Card.Body className="p-4">
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
            ...
            {/* Tombol Icon Mata tetap ada untuk privasi */}
            <Button 
                variant="link" 
        ...
        {/* Area Ringkasan Angka (Pemasukan, Pengeluaran, Total) */}
        {loading ? (
        ...
        {/* Filter Unit (Minggu, Bulan, Tahun) */}
        <div className="d-flex gap-2 mt-4 bg-light p-1 rounded-pill">
            ...
            {/* Area List Transaksi yang bisa di-scroll dengan Limit 10 */}
<div style={{ flexGrow: 1, overflowY: 'auto', paddingRight: '5px' }} className="px-1">
    {hasNoData ? (
        ...
        /* Menambahkan .slice(0, 10) untuk membatasi jumlah data */
        transactions.slice(0, 10).map((tx) => (
            <Card key={tx.id_transaksi} className="mb-3 shadow-sm border-0 mx-1" style={{ borderRadius: '15px' }}>
                <Card.Body className="p-3">
                    <div className="d-flex flex-column">
                        ...
                        {/* Baris Bawah: Tanggal dan Nominal */}
                        <div className="d-flex justify-content-between align-items-center">
                            {/* Tanggal */}
            ...
            {/* Tombol Tambah Transaksi melayang di bawah */}
            {!hideAddButton && (
